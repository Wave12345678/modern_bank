...
const Hero = () =>(
  ...
  <div className='ss:flex hidden md:mr-4 mr-0'>
    ...
    <h1 className='font-popins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full'>Payment Method.</h1>
...
We examine annual percentage rates, annual fees.</p>
  ...
  <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
    ...
    <div className='absolute z-[0] w-[50%] h-[55%] right-20 bottom-20 blue__gradient pink__gradient'/>
  </div>
